...
const SIZES = {
  ...
  lg: { height: 'var(--control-h-lg)', padding: '0 24px', fontSize: 'var(--text-lg)' },
};
...
export function Button({ variant = 'primary', size = 'md', disabled = false, fullWidth = false, onClick, children, style }) {
  ...
  return (
    <button
      ...
      style={{
        ...
        color: v.color, background: hover && !disabled ? v.hover : v.bg,
        border: v.border, borderRadius: 'var(--radius-md)',
