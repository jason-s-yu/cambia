...
var QueueConfigs = map[string]QueueConfig{
	"h2h_quickplay":  {QueueID: "h2h_quickplay", Players: 2, Rounds: 1, RatingPool: "h2h_qp", Ranked: true, HiddenRating: true, DisconnectGraceSec: 60},
	"h2h_blitz":      {QueueID: "h2h_blitz", Players: 2, Rounds: 4, RatingPool: "h2h_ranked", Ranked: true, DisconnectGraceSec: 60},
	"h2h_rapid":      {QueueID: "h2h_rapid", Players: 2, Rounds: 8, RatingPool: "h2h_ranked", Ranked: true, DisconnectGraceSec: 60},
	"h2h_classical":  {QueueID: "h2h_classical", Players: 2, Rounds: 16, RatingPool: "h2h_ranked", Ranked: true, DisconnectGraceSec: 60},
	"ffa4_standard":  {QueueID: "ffa4_standard", Players: 4, Rounds: 8, RatingPool: "ffa4", Ranked: true, DisconnectGraceSec: 60},
	"ffa4_classical": {QueueID: "ffa4_classical", Players: 4, Rounds: 12, RatingPool: "ffa4", Ranked: true, DisconnectGraceSec: 60},
}
