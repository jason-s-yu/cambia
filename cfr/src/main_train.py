...
def setup_logging(
    ...
    try:
        ...
        if live_display_manager is not None:
            ...
            logging.info("Console output: headless mode (plain-text stdout)")
...
def create_infrastructure(
    ...
    Args:
        ...
        headless: If True, skip LiveDisplayManager (plain-text stdout output instead)
    ...
    # Create LiveDisplayManager (skipped in headless mode)
...
def run_deep_training(
    ...
    Args:
        ...
        headless: Ignored here; headless mode is configured via infra.live_display_manager
